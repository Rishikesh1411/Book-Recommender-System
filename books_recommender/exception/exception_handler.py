...
class AppException(Exception):
    """
    AppException is a customized exception class designed to capture refined details about exceptions,
    such as Python script file line number along with an error message.
    With this custom exception, one can easily spot the source of the error and provide a quick fix.

    Created by: Rishikesh Raj, IIT Patna
